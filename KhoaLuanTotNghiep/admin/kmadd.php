 ...
 <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(strtotime($NgayBatDau) < strtotime(date('Y-m-d'))) {
            $insertBrand = "Ngày bắt đầu không thể nhỏ hơn ngày hiện tại!";
        } elseif(strtotime($NgayKetThuc) < strtotime($NgayBatDau)) {
            $insertBrand = "Ngày kết thúc không thể nhỏ hơn ngày bắt đầu!";
        } else {
            $insertBrand = $brand->insert_brand($TenKhuyenMai,$TienKhuyenMai,$NgayBatDau,$NgayKetThuc);
        }        
    }
?> 
<?php  ?>
<div class="grid_10">
    <div class="box round first grid">
        ...
        <div class="block copyblock"> 
            ...
            ?> 
            <form  action="kmadd.php" method="post">
                <table class="form">					
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="TenKhuyenMai" placeholder="Nhập tên Khuyến Mãi..." class="medium" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" id="TienKhuyenMai" name="TienKhuyenMai" placeholder="Nhập số % Khuyến Mãi..." class="medium" />     
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="date" name="NgayBatDau" placeholder="Ngày bắt đầu..." class="medium" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="date" name="NgayKetThuc" placeholder="Ngày hết hạn..." class="medium" />
                        </td>
                    </tr>
                    <tr> 
                        <td>
