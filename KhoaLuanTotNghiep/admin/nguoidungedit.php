...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $updateBrand = $brand->update_brand1($TenNguoiDung,$DiaChi,$SDT,$Email,$MatKhau,$XacNhanMatKhau,$id);
                 ...
                 <form action="" method="post">
                    <table class="form">					
                        ...
                        <tr>
                            ...
                            <td>
                                <input style="width: 300px;" type="password" value="<?php echo $result['XacNhanMatKhau']; ?>" name="XacNhanMatKhau" id="" readonly  class="medium"  />
                            </td>
                        </tr>
