                    ...
                    <tr>
                            ...
                            <td>
                                <select style="width: 310px;" id="select" name="IDNguoiDung">
                                    ...
                                    <option
                                    <?php
                                    if($result['IDNguoiDung']==$result['IDNguoiDung']){ echo 'selected';  }
                                    ?>

                                    value="<?php echo $result['IDNguoiDung'] ?>"><?php echo $result['TenNguoiDung'] ?></option>
                    ...
                    <tr>
                            ...
                            <td>
                                <select style="width: 310px;" id="select" name="IDQuyen">
                                    ...
                                    <option
                                    <?php
                                    if($result['IDQuyen']==$result['IDQuyen']){ echo 'selected';  }
                                    ?>

                                    value="<?php echo $result['IDQuyen'] ?>"><?php echo $result['TenQuyen'] ?></option>
