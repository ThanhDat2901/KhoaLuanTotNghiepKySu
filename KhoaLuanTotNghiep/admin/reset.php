...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $updateBrand = $brand->update_brand1($TenNguoiDung,$DiaChi,$SDT,$Email,'$1111','$1111',$id);        
    }
?>
<?php  ?>
        <div class="grid_10">
                 ...
                 <form action="" method="post">
                    <table class="form">					
                        ...
                        <tr style="display:none;">
                            ...
                            <td>
                                <input style="width: 300px;" type="password" value="<?php echo htmlspecialchars($result['XacNhanMatKhau'], ENT_QUOTES, 'UTF-8'); ?>" name="XacNhanMatKhau" id="confirmPasswordInput" placeholder="*****" class="medium"   />
                            </td>
                        </tr>
