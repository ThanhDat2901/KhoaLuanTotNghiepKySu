...
<?php
	...
	class product
	{
		...
		{
			$sql = "SELECT * FROM sanpham INNER JOIN loaisanpham ON sanpham.IDLoai = loaisanpham.IDLoai ORDER BY sanpham.IDSanPham DESC LIMIT 4";
		...
		public function getChiTietBoSuuTapById($id){
			...
			WHERE sanpham.IDSanPham = chitietbosuutap.IDSanPham 
				...
				and bosuutap.IDBoSuuTap= '$id' ORDER BY sanpham.IDSanPham DESC LIMIT 4";
		...
		public function insert_product($data,$files){
			...
			|| $IDLoai=="" || $IDKhuyenMai==""| $HinhAnh ==""){
				...
				$query = "INSERT INTO sanpham(TenSanPham,ThongTin,GiaDau,GiaCuoi,IDLoai,IDKhuyenMai,type,HinhAnh) VALUES('$TenSanPham','$ThongTin','$GiaDau','$GiaCuoi','$IDLoai','$IDKhuyenMai','$type','$HinhAnh')";
