							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
									...
									<li class="nav-item dropdown" >
											...
											<?php foreach($databosuutap as  $bosuutapitem ):?> 
												<li><a class="dropdown-item white-text" href="#"><?php echo $bosuutapitem['TenBoSuuTap'] ?></a></li>
												<!-- <li><a class="dropdown-item white-text" href="/bo-suu-tap/beginner-thoi-trang-the-thao?sort=2">SALE 20% Beginner (Thể Thao)</a></li>
												<li><a class="dropdown-item white-text" href="/bo-suu-tap/seventy-seven?sort=11">Seventy Seven (Hot Trend Giá Tốt)</a></li>
												<li><a class="dropdown-item white-text" href="/bo-suu-tap/bo-suu-tap-the-seafarer-thuy-thu?sort=2">The Seafarer (Thủy Thủ)</a></li>
												<li><a class="dropdown-item white-text" href="/bo-suu-tap/thoi-trang-premium-cao-cap?sort=11">Premium (Đơn Giản Cao Cấp)</a></li>
												<li><a class="dropdown-item white-text" href="/bo-suu-tap/thoi-trang-don-gian-gia-re?sort=2">No Style &amp; Cosmo (Đơn Giản Giá Tốt)</a></li>
												<li><a class="dropdown-item white-text" href="/bo-suu-tap/Cool-Touch?sort=11">Cool Touch (Vải Làm Mát)</a></li>
												<li><a class="dropdown-item white-text" href="/bo-suu-tap/Wrinkle-free-vai-khong-can-ui?sort=11">Wrinkle Free (Vải Ít Nhăn)</a></li>
												<li><a class="dropdown-item white-text" href="/bo-suu-tap/the-days-eye?sort=11">The Day's Eye (Fan Của Hoa Cúc)</a></li>
												<li><a class="dropdown-item white-text"  href="/bo-suu-tap/mien-gio-cat?sort=11">Miền Gió Cát (Fan Của Màu Be)</a></li>
												<li><a class="dropdown-item white-text" href="/bo-suu-tap/thoi-trang-One-Piece-YaMe?sort=2">One Piece x YaMe</a></li>
												<li><a class="dropdown-item white-text" href="/bo-suu-tap/di-san?sort=11">Di Sản (Fan Cứng Của YaMe)</a></li> -->
												<?php endforeach ;?>
											</ul>
									</li>
									...
									<li class="nav-item dropdown"  style="margin-left: 10px;">
										...
										<li><a class="dropdown-item white-text" href="/shop/hang-mo-ban?sort=11">Hàng Mới</a></li>
										<li><a class="dropdown-item white-text" href="/shop/ao-thun?sort=11">Áo Thun</a></li>
										...
										<li class="nav-item"  style="margin-left: 10px;">
											...
											<div class="collapse navbar-collapse" id="navbarSupportedContent">
											<button class="btn btn-outline-white  position:fixed"><i class="fa-solid fa-magnifying-glass"></i></button>
												<div >
