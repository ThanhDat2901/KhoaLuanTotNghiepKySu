    ...
    public static function login($pdo, $Email, $MatKhau)
{
    if (empty($Email) || empty($MatKhau)) {
        ...
        $sql = "SELECT thongtinnguoidung.IDNguoiDung, TenNguoiDung, Email, MatKhau,phanquyen.IDQuyen as idpq FROM thongtinnguoidung,phanquyen,quyen 
